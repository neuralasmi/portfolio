// Vendored from @designcodeio/threeui (MIT) — LiquidForm shaders.
// Modified vs upstream: background forced to true black (bgCol 0.02/0.05 -> 0.0,
// bloom emission removed) so the canvas melts into dark pages instead of
// rendering the stock dark-grey backdrop.
